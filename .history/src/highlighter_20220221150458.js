      ...
      <section className="card">
        <div>
          ...
          <div className="margin-top-zero txt">
            Here is react highlighter with hook and use state, I could't store
            the highlightedText in the state the point was e.preventDefault(),
            now the state is get updated and the app is super simple to use and
            understand.
          </div>
